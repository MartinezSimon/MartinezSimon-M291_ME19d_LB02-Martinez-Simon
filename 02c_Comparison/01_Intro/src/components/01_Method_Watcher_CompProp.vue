<template>
  <div>
    <h1>Brand new releases at the Geneva International Motorshow</h1>
...
export default {
  data() {
    return {
      // Shared
      carList: [
        'Bugatti Veyron', 'Nissan GTR', 'Mercedes AMG S63 ', 'Audi RS6',
        'Ferrari M2', 'Maserati Gran Turismo', 'Nissan 400z', 'Toyota GT86 GR',
        'Bugatti Chiron', 'BMW X7', 'Lexus LFA', 'Mc Laren F1',
        'Pagani Zonda', ' Maserati MC20', 'Koenigsegg Gemera'
      ],
      // Method
      input: '',
      methodFilterList: [],
...
.container {
  margin: 0 auto;
  padding: 30px;
  max-width: 100%;  font-family: 'Verdana', Helvetica, Arial, sans-serif;
}
.col {
  margin-bottom: 2rem;
  width: 100%;
